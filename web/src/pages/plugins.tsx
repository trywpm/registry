...
export const PluginsPage = async (c: Context) => {
  ...
  const totalPackages = await getPackagesCount(session, env.cache, c.executionCtx, 'plugin');
  ...
  return c.html(
    ...
    >
      <main>
        <Hero grid>
          <HeroHeading>WordPress Plugins</HeroHeading>
          <HeroDescription>Discover and manage WordPress plugins with wpm.</HeroDescription>
        </Hero>
